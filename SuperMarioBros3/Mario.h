...
#define MARIO_FLYING_SPEED_MAX		0.06f
#define MARIO_IMMINANT_WALKING_SPEED		0.02f
#define MARIO_JUMP_SPEED_Y		0.2f
#define MARIO_HIGH_JUMP_SPEED_Y		0.6f
#define MARIO_JUMP_DEFLECT_SPEED 0.3f
#define LUIGI_JUMP_DEFLECT_SPEED	0.72f
#define MARIO_GRAVITY			0.002f
#define MARIO_RACCOON_FLY_GRAVITY_COEFFICIENT 0.37f
#define MARIO_DIE_DEFLECT_SPEED	 0.5f
#define MARIO_MAX_FALL_SPEED	0.3f
#define MARIO_MAX_FALL_SLOWLY_SPEED	0.05f
